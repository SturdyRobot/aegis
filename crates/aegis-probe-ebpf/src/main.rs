//! Kernel-side eBPF LSM programs for aegis-probe.
//!
...
//! against your exact aya-ebpf version — see ../aegis-probe/BUILD_EBPF.md.
//!
...
/// `aegis_probe::RawViolation` byte-for-byte.
#[repr(C)]
#[derive(Clone, Copy)]
...
/// TGIDs Aegis supervises → policy flag byte. The hooks are inert for any process
